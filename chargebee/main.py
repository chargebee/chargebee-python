...
class Chargebee:
    ...
    def __init__(
        ...
        self.AppliedBusinessRule = chargebee.AppliedBusinessRule(self.env)
        self.AppliedRule = chargebee.AppliedRule(self.env)
        self.ApplyRule = chargebee.ApplyRule(self.env)
        self.AsyncResponse = chargebee.AsyncResponse(self.env)
        self.AsyncResponseList = chargebee.AsyncResponseList(self.env)
        ...
        self.BusinessRule = chargebee.BusinessRule(self.env)
        self.BusinessRuleset = chargebee.BusinessRuleset(self.env)
        self.BusinessRulesetRule = chargebee.BusinessRulesetRule(self.env)
        self.Card = chargebee.Card(self.env)
        self.ColumnDefinition = chargebee.ColumnDefinition(self.env)
        ...
        self.CustomDataSchema = chargebee.CustomDataSchema(self.env)
        ...
        self.MeteredFeature = chargebee.MeteredFeature(self.env)
        ...
        self.PromotionalGrant = chargebee.PromotionalGrant(self.env)
