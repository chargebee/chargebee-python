...
class Customers(TypedDict):
    ...
    auto_collection: Required[enums.AutoCollection]
    offline_payment_method: NotRequired[enums.OfflinePaymentMethod]
    net_term_days: Required[int]
    vat_number_validated_time: NotRequired[int]
    vat_number_status: NotRequired[VatNumberStatus]
    allow_direct_debit: Required[bool]
    ...
    pii_cleared: NotRequired[PiiCleared]
    auto_close_invoices: NotRequired[bool]
    channel: NotRequired[enums.Channel]
    active_id: NotRequired[str]
    card_status: NotRequired[CardStatus]
    fraud_flag: NotRequired[FraudFlag]
    primary_payment_source_id: NotRequired[str]
    backup_payment_source_id: NotRequired[str]
    billing_address: NotRequired[BillingAddress]
    referral_urls: NotRequired[List[ReferralUrl]]
    ...
    refundable_credits: Required[int]
    excess_payments: Required[int]
    balances: NotRequired[List[Balance]]
    entity_identifiers: NotRequired[List[EntityIdentifier]]
    ...
    parent_account_access: NotRequired[ParentAccountAccess]
    child_account_access: NotRequired[ChildAccountAccess]
