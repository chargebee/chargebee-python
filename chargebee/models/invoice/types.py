...
class Invoices(TypedDict):
    ...
    dunning_status: NotRequired[DunningStatus]
    next_retry_at: NotRequired[int]
    voided_at: NotRequired[int]
    resource_version: NotRequired[int]
    updated_at: NotRequired[int]
    sub_total: Required[int]
    sub_total_in_local_currency: NotRequired[int]
    total_in_local_currency: NotRequired[int]
    local_currency_code: NotRequired[str]
    tax: Required[int]
    local_currency_exchange_rate: NotRequired[float]
    first_invoice: NotRequired[bool]
    new_sales_amount: NotRequired[int]
    has_advance_charges: NotRequired[bool]
    term_finalized: Required[bool]
    is_gifted: Required[bool]
    generated_at: NotRequired[int]
    expected_payment_date: NotRequired[int]
    amount_to_collect: NotRequired[int]
    ...
    dunning_attempts: NotRequired[List[DunningAttempt]]
    applied_credits: NotRequired[List[AppliedCredit]]
    adjustment_credit_notes: NotRequired[List[AdjustmentCreditNote]]
    issued_credit_notes: NotRequired[List[IssuedCreditNote]]
    linked_orders: NotRequired[List[LinkedOrder]]
    notes: NotRequired[List[Note]]
    shipping_address: NotRequired[ShippingAddress]
    statement_descriptor: NotRequired[StatementDescriptor]
    billing_address: NotRequired[BillingAddress]
    einvoice: NotRequired[Einvoice]
    payment_owner: NotRequired[str]
    ...
    site_details_at_creation: NotRequired[SiteDetailsAtCreation]
    tax_origin: NotRequired[TaxOrigin]
