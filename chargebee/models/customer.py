...
class Customer(Model):
    ...
    "preferred_currency_code", "promotional_credits", "unbilled_charges", "refundable_credits", \
    "excess_payments", "balances", "entity_identifiers", "is_einvoice_enabled", "meta_data", "deleted", \
