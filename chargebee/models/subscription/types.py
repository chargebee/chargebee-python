...
class Subscriptions(TypedDict):
    ...
    plan_amount: NotRequired[int]
    plan_free_quantity: NotRequired[int]
    ...
    cancel_reason: NotRequired[CancelReason]
    affiliate_token: NotRequired[str]
    created_from_ip: NotRequired[str]
    resource_version: NotRequired[int]
    updated_at: NotRequired[int]
    has_scheduled_advance_invoices: Required[bool]
    has_scheduled_changes: Required[bool]
    payment_source_id: NotRequired[str]
    plan_free_quantity_in_decimal: NotRequired[str]
    plan_amount_in_decimal: NotRequired[str]
    cancel_schedule_created_at: NotRequired[int]
    ...
    charged_items: NotRequired[List[ChargedItem]]
    due_invoices_count: NotRequired[int]
    due_since: NotRequired[int]
    total_dues: NotRequired[int]
    mrr: NotRequired[int]
    arr: NotRequired[int]
    exchange_rate: NotRequired[float]
    base_currency_code: NotRequired[str]
    addons: NotRequired[List[Addon]]
    event_based_addons: NotRequired[List[EventBasedAddon]]
    charged_event_based_addons: NotRequired[List[ChargedEventBasedAddon]]
    coupon: NotRequired[str]
    coupons: NotRequired[List[Coupon]]
    shipping_address: NotRequired[ShippingAddress]
    referral_info: NotRequired[ReferralInfo]
