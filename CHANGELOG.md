...
* * *
### New Resources:
- [`AppliedBusinessRule`](https://apidocs.chargebee.com/docs/api/applied_business_rules) has been added.
- [`AppliedRule`](https://apidocs.chargebee.com/docs/api/applied_rules) has been added.
- [`ApplyRule`](https://apidocs.chargebee.com/docs/api/apply_rules) has been added.
- [`BusinessRule`](https://apidocs.chargebee.com/docs/api/business_rules) has been added.
- [`BusinessRuleset`](https://apidocs.chargebee.com/docs/api/business_rulesets) has been added.
- [`BusinessRulesetRule`](https://apidocs.chargebee.com/docs/api/business_ruleset_rules) has been added.
- [`CustomDataSchema`](https://apidocs.chargebee.com/docs/api/custom_data_schemas) has been added.
- [`Dispute`](https://apidocs.chargebee.com/docs/api/disputes) has been added.
- [`EmailLog`](https://apidocs.chargebee.com/docs/api/email_logs) has been added.


### New Actions:
- [`send_credit_note_email`](https://apidocs.chargebee.com/docs/api/credit_notes/send-credit-note-email) has been added to [`CreditNote`](https://apidocs.chargebee.com/docs/api/credit_notes).
- [`send_payment_request_email`](https://apidocs.chargebee.com/docs/api/customers/send-payment-request-email) has been added to [`Customer`](https://apidocs.chargebee.com/docs/api/customers).
- [`list_e-invoices`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices) has been added to [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`retrieve_an_e-invoice`](https://apidocs.chargebee.com/docs/api/einvoices/retrieve-an-e-invoice) has been added to [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`send_invoice_email`](https://apidocs.chargebee.com/docs/api/invoices/send-invoice-email) has been added to [`Invoice`](https://apidocs.chargebee.com/docs/api/invoices).
- [`list_payment_schedules`](https://apidocs.chargebee.com/docs/api/payment_schedules/list-payment-schedules) has been added to [`PaymentSchedule`](https://apidocs.chargebee.com/docs/api/payment_schedules).
- [`list_payment_schedule_schemes`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes/list-payment-schedule-schemes) has been added to [`PaymentScheduleScheme`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes).


### New Attributes:
- [`brand_id`](https://apidocs.chargebee.com/docs/api/credit_notes/credit-note-object#brand_id) has been added to [`CreditNote`](https://apidocs.chargebee.com/docs/api/credit_notes).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/customers/customer-object#brand_id) has been added to [`Customer`](https://apidocs.chargebee.com/docs/api/customers).
- [`entity_type`](https://apidocs.chargebee.com/docs/api/einvoices/einvoice-object#entity_type) has been added to [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`entity_id`](https://apidocs.chargebee.com/docs/api/einvoices/einvoice-object#entity_id) has been added to [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`created_at`](https://apidocs.chargebee.com/docs/api/einvoices/einvoice-object#created_at) has been added to [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`resource_version`](https://apidocs.chargebee.com/docs/api/einvoices/einvoice-object#resource_version) has been added to [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`updated_at`](https://apidocs.chargebee.com/docs/api/einvoices/einvoice-object#updated_at) has been added to [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`deleted`](https://apidocs.chargebee.com/docs/api/einvoices/einvoice-object#deleted) has been added to [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`business_entity_id`](https://apidocs.chargebee.com/docs/api/einvoices/einvoice-object#business_entity_id) has been added to [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`artifacts`](https://apidocs.chargebee.com/docs/api/einvoices/einvoice-object#artifacts) has been added to [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`site_id`](https://apidocs.chargebee.com/docs/api/events/event-object#site_id) has been added to [`Event`](https://apidocs.chargebee.com/docs/api/events).
- [`provisioned_block_balance`](https://apidocs.chargebee.com/docs/api/grant_blocks/grant-block-object#provisioned_block_balance) has been added to [`GrantBlock`](https://apidocs.chargebee.com/docs/api/grant_blocks).
- [`overdraft_block_balance`](https://apidocs.chargebee.com/docs/api/grant_blocks/grant-block-object#overdraft_block_balance) has been added to [`GrantBlock`](https://apidocs.chargebee.com/docs/api/grant_blocks).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/hosted_pages/hosted-page-object#brand_id) has been added to [`HostedPage`](https://apidocs.chargebee.com/docs/api/hosted_pages).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/invoices/invoice-object#brand_id) has been added to [`Invoice`](https://apidocs.chargebee.com/docs/api/invoices).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/payment_intents/payment-intent-object#brand_id) has been added to [`PaymentIntent`](https://apidocs.chargebee.com/docs/api/payment_intents).
- [`reference_transactions`](https://apidocs.chargebee.com/docs/api/payment_schedules/payment-schedule-object#reference_transactions) has been added to [`PaymentSchedule`](https://apidocs.chargebee.com/docs/api/payment_schedules).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/payment_sources/payment-source-object#brand_id) has been added to [`PaymentSource`](https://apidocs.chargebee.com/docs/api/payment_sources).
- [`network_transaction_reference`](https://apidocs.chargebee.com/docs/api/payment_sources/payment-source-object#network_transaction_reference) has been added to [`PaymentSource`](https://apidocs.chargebee.com/docs/api/payment_sources).
- [`billing_configuration`](https://apidocs.chargebee.com/docs/api/ramps/ramp-object#billing_configuration) has been added to [`Ramp`](https://apidocs.chargebee.com/docs/api/ramps).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/subscriptions/subscription-object#brand_id) has been added to [`Subscription`](https://apidocs.chargebee.com/docs/api/subscriptions).
- [`network_transaction_reference`](https://apidocs.chargebee.com/docs/api/third_party_payment_methods/third-party-payment-method-object#network_transaction_reference) has been added to [`ThirdPartyPaymentMethod`](https://apidocs.chargebee.com/docs/api/third_party_payment_methods).
- [`network_transaction_details`](https://apidocs.chargebee.com/docs/api/transactions/transaction-object#network_transaction_details) has been added to [`Transaction`](https://apidocs.chargebee.com/docs/api/transactions).


### New Parameters:
- [`limit`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices#limit) has been added as query parameter to [`list_e-invoices`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices) in [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`offset`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices#offset) has been added as query parameter to [`list_e-invoices`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices) in [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`id`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices#id) has been added as query parameter to [`list_e-invoices`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices) in [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`reference_id`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices#reference_id) has been added as query parameter to [`list_e-invoices`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices) in [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`updated_at`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices#updated_at) has been added as query parameter to [`list_e-invoices`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices) in [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`sort_by`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices#sort_by) has been added as query parameter to [`list_e-invoices`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices) in [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`invoice_id`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices#invoice_id) has been added as query parameter to [`list_e-invoices`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices) in [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`credit_note_id`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices#credit_note_id) has been added as query parameter to [`list_e-invoices`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices) in [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- [`limit`](https://apidocs.chargebee.com/docs/api/payment_schedules/list-payment-schedules#limit) has been added as query parameter to [`list_payment_schedules`](https://apidocs.chargebee.com/docs/api/payment_schedules/list-payment-schedules) in [`PaymentSchedule`](https://apidocs.chargebee.com/docs/api/payment_schedules).
- [`offset`](https://apidocs.chargebee.com/docs/api/payment_schedules/list-payment-schedules#offset) has been added as query parameter to [`list_payment_schedules`](https://apidocs.chargebee.com/docs/api/payment_schedules/list-payment-schedules) in [`PaymentSchedule`](https://apidocs.chargebee.com/docs/api/payment_schedules).
- [`invoice_id`](https://apidocs.chargebee.com/docs/api/payment_schedules/list-payment-schedules#invoice_id) has been added as query parameter to [`list_payment_schedules`](https://apidocs.chargebee.com/docs/api/payment_schedules/list-payment-schedules) in [`PaymentSchedule`](https://apidocs.chargebee.com/docs/api/payment_schedules).
- [`id`](https://apidocs.chargebee.com/docs/api/payment_schedules/list-payment-schedules#id) has been added as query parameter to [`list_payment_schedules`](https://apidocs.chargebee.com/docs/api/payment_schedules/list-payment-schedules) in [`PaymentSchedule`](https://apidocs.chargebee.com/docs/api/payment_schedules).
- [`updated_at`](https://apidocs.chargebee.com/docs/api/payment_schedules/list-payment-schedules#updated_at) has been added as query parameter to [`list_payment_schedules`](https://apidocs.chargebee.com/docs/api/payment_schedules/list-payment-schedules) in [`PaymentSchedule`](https://apidocs.chargebee.com/docs/api/payment_schedules).
- [`limit`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes/list-payment-schedule-schemes#limit) has been added as query parameter to [`list_payment_schedule_schemes`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes/list-payment-schedule-schemes) in [`PaymentScheduleScheme`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes).
- [`offset`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes/list-payment-schedule-schemes#offset) has been added as query parameter to [`list_payment_schedule_schemes`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes/list-payment-schedule-schemes) in [`PaymentScheduleScheme`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes).
- [`id`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes/list-payment-schedule-schemes#id) has been added as query parameter to [`list_payment_schedule_schemes`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes/list-payment-schedule-schemes) in [`PaymentScheduleScheme`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes).
- [`updated_at`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes/list-payment-schedule-schemes#updated_at) has been added as query parameter to [`list_payment_schedule_schemes`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes/list-payment-schedule-schemes) in [`PaymentScheduleScheme`](https://apidocs.chargebee.com/docs/api/payment_schedule_schemes).
- [`line_items.is_partial_tax_applied`](https://apidocs.chargebee.com/docs/api/credit_notes/import-credit-note#line_items_is_partial_tax_applied) has been added as request body parameter to [`import_credit_note`](https://apidocs.chargebee.com/docs/api/credit_notes/import-credit-note) in [`CreditNote`](https://apidocs.chargebee.com/docs/api/credit_notes).
- [`line_items.taxable_amount`](https://apidocs.chargebee.com/docs/api/credit_notes/import-credit-note#line_items_taxable_amount) has been added as request body parameter to [`import_credit_note`](https://apidocs.chargebee.com/docs/api/credit_notes/import-credit-note) in [`CreditNote`](https://apidocs.chargebee.com/docs/api/credit_notes).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/customers/create-a-customer#brand_id) has been added as request body parameter to [`create_a_customer`](https://apidocs.chargebee.com/docs/api/customers/create-a-customer) in [`Customer`](https://apidocs.chargebee.com/docs/api/customers).
- [`subscription_items.description`](https://apidocs.chargebee.com/docs/api/estimates/estimate-for-creating-a-customer-and-subscription#subscription_items_description) has been added as request body parameter to [`estimate_for_creating_a_customer_and_subscription`](https://apidocs.chargebee.com/docs/api/estimates/estimate-for-creating-a-customer-and-subscription) in [`Estimate`](https://apidocs.chargebee.com/docs/api/estimates).
- [`subscription_items.description`](https://apidocs.chargebee.com/docs/api/estimates/estimate-for-updating-a-subscription#subscription_items_description) has been added as request body parameter to [`estimate_for_updating_a_subscription`](https://apidocs.chargebee.com/docs/api/estimates/estimate-for-updating-a-subscription) in [`Estimate`](https://apidocs.chargebee.com/docs/api/estimates).
- [`subscription_items.description`](https://apidocs.chargebee.com/docs/api/estimates/estimate-for-creating-a-subscription#subscription_items_description) has been added as request body parameter to [`estimate_for_creating_a_subscription`](https://apidocs.chargebee.com/docs/api/estimates/estimate-for-creating-a-subscription) in [`Estimate`](https://apidocs.chargebee.com/docs/api/estimates).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/hosted_pages/checkout-charge-items-and-one-time-charges#brand_id) has been added as request body parameter to [`checkout_charge-items_and_one-time_charges`](https://apidocs.chargebee.com/docs/api/hosted_pages/checkout-charge-items-and-one-time-charges) in [`HostedPage`](https://apidocs.chargebee.com/docs/api/hosted_pages).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/hosted_pages/extend-subscription#brand_id) has been added as request body parameter to [`extend_subscription`](https://apidocs.chargebee.com/docs/api/hosted_pages/extend-subscription) in [`HostedPage`](https://apidocs.chargebee.com/docs/api/hosted_pages).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/hosted_pages/checkout-gift-subscription-for-items#brand_id) has been added as request body parameter to [`checkout_gift_subscription_for_items`](https://apidocs.chargebee.com/docs/api/hosted_pages/checkout-gift-subscription-for-items) in [`HostedPage`](https://apidocs.chargebee.com/docs/api/hosted_pages).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/hosted_pages/collect-now#brand_id) has been added as request body parameter to [`collect_now`](https://apidocs.chargebee.com/docs/api/hosted_pages/collect-now) in [`HostedPage`](https://apidocs.chargebee.com/docs/api/hosted_pages).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/hosted_pages/accept-a-quote#brand_id) has been added as request body parameter to [`accept_a_quote`](https://apidocs.chargebee.com/docs/api/hosted_pages/accept-a-quote) in [`HostedPage`](https://apidocs.chargebee.com/docs/api/hosted_pages).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/hosted_pages/create-checkout-for-a-new-subscription#brand_id) has been added as request body parameter to [`create_checkout_for_a_new_subscription`](https://apidocs.chargebee.com/docs/api/hosted_pages/create-checkout-for-a-new-subscription) in [`HostedPage`](https://apidocs.chargebee.com/docs/api/hosted_pages).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/hosted_pages/claim-a-gift-subscription#brand_id) has been added as request body parameter to [`claim_a_gift_subscription`](https://apidocs.chargebee.com/docs/api/hosted_pages/claim-a-gift-subscription) in [`HostedPage`](https://apidocs.chargebee.com/docs/api/hosted_pages).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/hosted_pages/create-checkout-to-update-a-subscription#brand_id) has been added as request body parameter to [`create_checkout_to_update_a_subscription`](https://apidocs.chargebee.com/docs/api/hosted_pages/create-checkout-to-update-a-subscription) in [`HostedPage`](https://apidocs.chargebee.com/docs/api/hosted_pages).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/hosted_pages/create-a-pre-cancel-hosted-page#brand_id) has been added as request body parameter to [`create_a_pre-cancel_hosted_page`](https://apidocs.chargebee.com/docs/api/hosted_pages/create-a-pre-cancel-hosted-page) in [`HostedPage`](https://apidocs.chargebee.com/docs/api/hosted_pages).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/hosted_pages/manage-payment-sources#brand_id) has been added as request body parameter to [`manage_payment_sources`](https://apidocs.chargebee.com/docs/api/hosted_pages/manage-payment-sources) in [`HostedPage`](https://apidocs.chargebee.com/docs/api/hosted_pages).
- [`line_items.is_partial_tax_applied`](https://apidocs.chargebee.com/docs/api/invoices/import-invoice#line_items_is_partial_tax_applied) has been added as request body parameter to [`import_invoice`](https://apidocs.chargebee.com/docs/api/invoices/import-invoice) in [`Invoice`](https://apidocs.chargebee.com/docs/api/invoices).
- [`line_items.taxable_amount`](https://apidocs.chargebee.com/docs/api/invoices/import-invoice#line_items_taxable_amount) has been added as request body parameter to [`import_invoice`](https://apidocs.chargebee.com/docs/api/invoices/import-invoice) in [`Invoice`](https://apidocs.chargebee.com/docs/api/invoices).
- [`id`](https://apidocs.chargebee.com/docs/api/ledger_operations/allocate#id) has been added as request body parameter to [`allocate`](https://apidocs.chargebee.com/docs/api/ledger_operations/allocate) in [`LedgerOperation`](https://apidocs.chargebee.com/docs/api/ledger_operations).
- [`effective_from`](https://apidocs.chargebee.com/docs/api/ledger_operations/allocate#effective_from) has been added as request body parameter to [`allocate`](https://apidocs.chargebee.com/docs/api/ledger_operations/allocate) in [`LedgerOperation`](https://apidocs.chargebee.com/docs/api/ledger_operations).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/payment_intents/create-a-payment-intent#brand_id) has been added as request body parameter to [`create_a_payment_intent`](https://apidocs.chargebee.com/docs/api/payment_intents/create-a-payment-intent) in [`PaymentIntent`](https://apidocs.chargebee.com/docs/api/payment_intents).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/payment_sources/create-using-permanent-token#brand_id) has been added as request body parameter to [`create_using_permanent_token`](https://apidocs.chargebee.com/docs/api/payment_sources/create-using-permanent-token) in [`PaymentSource`](https://apidocs.chargebee.com/docs/api/payment_sources).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/payment_sources/create-a-card-payment-source#brand_id) has been added as request body parameter to [`create_a_card_payment_source`](https://apidocs.chargebee.com/docs/api/payment_sources/create-a-card-payment-source) in [`PaymentSource`](https://apidocs.chargebee.com/docs/api/payment_sources).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/payment_sources/create-using-payment-intent#brand_id) has been added as request body parameter to [`create_using_payment_intent`](https://apidocs.chargebee.com/docs/api/payment_sources/create-using-payment-intent) in [`PaymentSource`](https://apidocs.chargebee.com/docs/api/payment_sources).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/payment_sources/create-a-voucher-payment-method#brand_id) has been added as request body parameter to [`create_a_voucher_payment_method`](https://apidocs.chargebee.com/docs/api/payment_sources/create-a-voucher-payment-method) in [`PaymentSource`](https://apidocs.chargebee.com/docs/api/payment_sources).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/payment_sources/create-using-gateway-temporary-token#brand_id) has been added as request body parameter to [`create_using_gateway_temporary_token`](https://apidocs.chargebee.com/docs/api/payment_sources/create-using-gateway-temporary-token) in [`PaymentSource`](https://apidocs.chargebee.com/docs/api/payment_sources).
- [`network_transaction_reference`](https://apidocs.chargebee.com/docs/api/payment_sources/update-a-card-payment-source#network_transaction_reference) has been added as request body parameter to [`update_a_card_payment_source`](https://apidocs.chargebee.com/docs/api/payment_sources/update-a-card-payment-source) in [`PaymentSource`](https://apidocs.chargebee.com/docs/api/payment_sources).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/payment_sources/create-using-chargebee-token#brand_id) has been added as request body parameter to [`create_using_chargebee_token`](https://apidocs.chargebee.com/docs/api/payment_sources/create-using-chargebee-token) in [`PaymentSource`](https://apidocs.chargebee.com/docs/api/payment_sources).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/payment_sources/create-a-bank-account-payment-source#brand_id) has been added as request body parameter to [`create_a_bank_account_payment_source`](https://apidocs.chargebee.com/docs/api/payment_sources/create-a-bank-account-payment-source) in [`PaymentSource`](https://apidocs.chargebee.com/docs/api/payment_sources).
...
- [`id`](https://apidocs.chargebee.com/docs/api/promotional_grants/create-promotional-grant#id) has been added as request body parameter to [`create_promotional_grant`](https://apidocs.chargebee.com/docs/api/promotional_grants/create-promotional-grant) in [`PromotionalGrant`](https://apidocs.chargebee.com/docs/api/promotional_grants).
- [`effective_from`](https://apidocs.chargebee.com/docs/api/promotional_grants/create-promotional-grant#effective_from) has been added as request body parameter to [`create_promotional_grant`](https://apidocs.chargebee.com/docs/api/promotional_grants/create-promotional-grant) in [`PromotionalGrant`](https://apidocs.chargebee.com/docs/api/promotional_grants).
- [`billing_configuration`](https://apidocs.chargebee.com/docs/api/ramps/create-a-ramp#billing_configuration) has been added as request body parameter to [`create_a_ramp`](https://apidocs.chargebee.com/docs/api/ramps/create-a-ramp) in [`Ramp`](https://apidocs.chargebee.com/docs/api/ramps).
- [`billing_configuration`](https://apidocs.chargebee.com/docs/api/ramps/update-a-subscription-ramp#billing_configuration) has been added as request body parameter to [`update_a_subscription_ramp`](https://apidocs.chargebee.com/docs/api/ramps/update-a-subscription-ramp) in [`Ramp`](https://apidocs.chargebee.com/docs/api/ramps).
- [`subscription_items.description`](https://apidocs.chargebee.com/docs/api/subscriptions/update-subscription-for-items#subscription_items_description) has been added as request body parameter to [`update_subscription_for_items`](https://apidocs.chargebee.com/docs/api/subscriptions/update-subscription-for-items) in [`Subscription`](https://apidocs.chargebee.com/docs/api/subscriptions).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/subscriptions/create-a-subscription#brand_id) has been added as request body parameter to [`create_a_subscription`](https://apidocs.chargebee.com/docs/api/subscriptions/create-a-subscription) in [`Subscription`](https://apidocs.chargebee.com/docs/api/subscriptions).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/subscriptions/create-subscription-for-customer#brand_id) has been added as request body parameter to [`create_subscription_for_customer`](https://apidocs.chargebee.com/docs/api/subscriptions/create-subscription-for-customer) in [`Subscription`](https://apidocs.chargebee.com/docs/api/subscriptions).
- [`subscription_items.description`](https://apidocs.chargebee.com/docs/api/subscriptions/import-subscription-for-items#subscription_items_description) has been added as request body parameter to [`import_subscription_for_items`](https://apidocs.chargebee.com/docs/api/subscriptions/import-subscription-for-items) in [`Subscription`](https://apidocs.chargebee.com/docs/api/subscriptions).
- [`subscription_items.description`](https://apidocs.chargebee.com/docs/api/subscriptions/create-subscription-for-items#subscription_items_description) has been added as request body parameter to [`create_subscription_for_items`](https://apidocs.chargebee.com/docs/api/subscriptions/create-subscription-for-items) in [`Subscription`](https://apidocs.chargebee.com/docs/api/subscriptions).
- [`brand_id`](https://apidocs.chargebee.com/docs/api/subscriptions/create-subscription-for-items#brand_id) has been added as request body parameter to [`create_subscription_for_items`](https://apidocs.chargebee.com/docs/api/subscriptions/create-subscription-for-items) in [`Subscription`](https://apidocs.chargebee.com/docs/api/subscriptions).


### New Events:
- [`business_rule_deleted`](https://apidocs.chargebee.com/docs/api/events/webhook/business_rule_deleted) has been added.
- [`business_rules_applied`](https://apidocs.chargebee.com/docs/api/events/webhook/business_rules_applied) has been added.
- [`business_ruleset_updated`](https://apidocs.chargebee.com/docs/api/events/webhook/business_ruleset_updated) has been added.
- [`business_rule_created`](https://apidocs.chargebee.com/docs/api/events/webhook/business_rule_created) has been added.
- [`einvoice_created`](https://apidocs.chargebee.com/docs/api/events/webhook/einvoice_created) has been added.
- [`business_ruleset_deactivated`](https://apidocs.chargebee.com/docs/api/events/webhook/business_ruleset_deactivated) has been added.
- [`business_ruleset_deleted`](https://apidocs.chargebee.com/docs/api/events/webhook/business_ruleset_deleted) has been added.
- [`business_ruleset_created`](https://apidocs.chargebee.com/docs/api/events/webhook/business_ruleset_created) has been added.
- [`business_ruleset_activated`](https://apidocs.chargebee.com/docs/api/events/webhook/business_ruleset_activated) has been added.
- [`business_rule_deactivated`](https://apidocs.chargebee.com/docs/api/events/webhook/business_rule_deactivated) has been added.
- [`einvoice_updated`](https://apidocs.chargebee.com/docs/api/events/webhook/einvoice_updated) has been added.
- [`business_rule_released`](https://apidocs.chargebee.com/docs/api/events/webhook/business_rule_released) has been added.
- [`business_rule_activated`](https://apidocs.chargebee.com/docs/api/events/webhook/business_rule_activated) has been added.
- [`business_rule_updated`](https://apidocs.chargebee.com/docs/api/events/webhook/business_rule_updated) has been added.


### New Enums:
- `business_ruleset` and `price_ramp` have been added as new values enum `EntityType`.
- `einvoice_created`, `einvoice_updated`, `business_rule_created`, `business_rule_updated`, `business_rule_activated`, `business_rule_deactivated`, `business_rule_deleted`, `business_rule_released`, `business_rules_applied`, `business_ruleset_created`, `business_ruleset_updated`, `business_ruleset_activated`, `business_ruleset_deactivated`, and `business_ruleset_deleted` have been added as new values enum `EventType`.
- `payu` has been added as a new value enum `Gateway`.
- `payu` has been added as a new value enum `GatewayName`.
- `blik`, `fpx`, `wero`, `p24`, `ovo`, `momo`, `mercado_pago`, `nequi`, `nupay`, `picpay`, `thai_qr`, `affirm_pay`, and `rakuten_pay` have been added as new values enum `PaymentMethod`.
- `ovo`, `momo`, `mercado_pago`, `nequi`, `nupay`, `picpay`, `thai_qr`, `blik`, `fpx`, `wero`, `p24`, `affirm_pay`, and `rakuten_pay` have been added as new values enum `PaymentMethodType`.
- `rescheduled`, `succeeded`, `failed`, `deferred`, `delivered`, `opened`, `bounced`, and `dropped` have been added as new values enum `Status`.
- `zero_rated` has been added as a new value enum `Taxability`.
- `ovo`, `momo`, `mercado_pago`, `nequi`, `nupay`, `picpay`, `thai_qr`, `blik`, `fpx`, `wero`, `p24`, `affirm_pay`, and `rakuten_pay` have been added as new values enum `Type`.
- `cpq_quote` has been added as a new value to enum attribute [`entity_type`](https://apidocs.chargebee.com/docs/api/applied_business_rules/applied-business-rule-object#entity_type) in [`AppliedBusinessRule`](https://apidocs.chargebee.com/docs/api/applied_business_rules).
- `stop_on_first_true`, `stop_on_first_false`, `execute_all`, and `execute_all_true` have been added as new values to enum attribute [`execute_mode`](https://apidocs.chargebee.com/docs/api/business_rulesets/business-ruleset-object#execute_mode) in [`BusinessRuleset`](https://apidocs.chargebee.com/docs/api/business_rulesets).
- `active` and `archived` have been added as new values to enum attribute [`status`](https://apidocs.chargebee.com/docs/api/custom_data_schemas/custom-data-schema-object#status) in [`CustomDataSchema`](https://apidocs.chargebee.com/docs/api/custom_data_schemas).
- `initiated`, `funds_withdrawn`, `in_review`, `cancelled`, `lost`, and `won` have been added as new values to enum attribute [`status`](https://apidocs.chargebee.com/docs/api/disputes/dispute-object#status) in [`Dispute`](https://apidocs.chargebee.com/docs/api/disputes).
- `chargeback` and `inquiry` have been added as new values to enum attribute [`type`](https://apidocs.chargebee.com/docs/api/disputes/dispute-object#type) in [`Dispute`](https://apidocs.chargebee.com/docs/api/disputes).
- `invoice` and `credit_note` have been added as new values to enum attribute [`entity_type`](https://apidocs.chargebee.com/docs/api/einvoices/einvoice-object#entity_type) in [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- `overdraft_settlement` has been added as a new value to enum attribute [`type`](https://apidocs.chargebee.com/docs/api/ledger_operations/ledger-operation-object#type) in [`LedgerOperation`](https://apidocs.chargebee.com/docs/api/ledger_operations).
- `subscription_not_found_in_source` has been added as a new value to enum attribute [`expiration_reason`](https://apidocs.chargebee.com/docs/api/omnichannel_subscription_items/omnichannel-subscription-item-object#expiration_reason) in [`OmnichannelSubscriptionItem`](https://apidocs.chargebee.com/docs/api/omnichannel_subscription_items).
- `ovo`, `momo`, `mercado_pago`, `nequi`, `nupay`, `picpay`, `thai_qr`, `blik`, `fpx`, `wero`, `p24`, `affirm_pay`, and `rakuten_pay` have been added as new values to enum attribute [`payment_method_type`](https://apidocs.chargebee.com/docs/api/payment_intents/payment-intent-object#payment_method_type) in [`PaymentIntent`](https://apidocs.chargebee.com/docs/api/payment_intents).
- `ovo`, `momo`, `mercado_pago`, `nequi`, `nupay`, `picpay`, `thai_qr`, `blik`, `fpx`, `wero`, `p24`, `affirm_pay`, and `rakuten_pay` have been added as new values to enum attribute [`active_payment_attempt.payment_method_type`](https://apidocs.chargebee.com/docs/api/payment_intents/payment-intent-object#active_payment_attempt_payment_method_type) in [`PaymentIntent`](https://apidocs.chargebee.com/docs/api/payment_intents).
- `true` and `false` have been added as new values to enum query parameter `draft.is` in [`list_business_rules`](https://apidocs.chargebee.com/docs/api/business_rules/list-business-rules) of [`BusinessRule`](https://apidocs.chargebee.com/docs/api/business_rules).
- `true` and `false` have been added as new values to enum query parameter `active.is` in [`list_business_rules`](https://apidocs.chargebee.com/docs/api/business_rules/list-business-rules) of [`BusinessRule`](https://apidocs.chargebee.com/docs/api/business_rules).
- `stop_on_first_true`, `stop_on_first_false`, `execute_all`, and `execute_all_true` have been added as new values to enum request body parameter `execute_mode` in [`update_a_business_ruleset`](https://apidocs.chargebee.com/docs/api/business_rulesets/update-a-business-ruleset) of [`BusinessRuleset`](https://apidocs.chargebee.com/docs/api/business_rulesets).
- `true` and `false` have been added as new values to enum query parameter `active.is` in [`list_rules_in_a_business_ruleset`](https://apidocs.chargebee.com/docs/api/business_rulesets/list-rules-in-a-business-ruleset) of [`BusinessRuleset`](https://apidocs.chargebee.com/docs/api/business_rulesets).
- `true` and `false` have been added as new values to enum query parameter `active.is` in [`list_business_rulesets`](https://apidocs.chargebee.com/docs/api/business_rulesets/list-business-rulesets) of [`BusinessRuleset`](https://apidocs.chargebee.com/docs/api/business_rulesets).
- `stop_on_first_true`, `stop_on_first_false`, `execute_all`, and `execute_all_true` have been added as new values to enum request body parameter `execute_mode` in [`create_a_business_ruleset`](https://apidocs.chargebee.com/docs/api/business_rulesets/create-a-business-ruleset) of [`BusinessRuleset`](https://apidocs.chargebee.com/docs/api/business_rulesets).
- `dankort` has been added as a new value to enum request body parameter `preferred_scheme` in [`update_card_for_a_customer`](https://apidocs.chargebee.com/docs/api/cards/update-card-for-a-customer) of [`Card`](https://apidocs.chargebee.com/docs/api/cards).
- `dankort` has been added as a new value to enum request body parameter `card.preferred_scheme` in [`create_a_customer`](https://apidocs.chargebee.com/docs/api/customers/create-a-customer) of [`Customer`](https://apidocs.chargebee.com/docs/api/customers).
- `dankort` has been added as a new value to enum request body parameter `card.preferred_scheme` in [`collect_payment_for_customer`](https://apidocs.chargebee.com/docs/api/customers/collect-payment-for-customer) of [`Customer`](https://apidocs.chargebee.com/docs/api/customers).
- `initiated`, `in_review`, `lost`, `funds_withdrawn`, `won`, and `cancelled` have been added as new values to enum query parameter `status.is` in [`list_disputes`](https://apidocs.chargebee.com/docs/api/disputes/list-disputes) of [`Dispute`](https://apidocs.chargebee.com/docs/api/disputes).
- `initiated`, `in_review`, `lost`, `funds_withdrawn`, `won`, and `cancelled` have been added as new values to enum query parameter `status.is_not` in [`list_disputes`](https://apidocs.chargebee.com/docs/api/disputes/list-disputes) of [`Dispute`](https://apidocs.chargebee.com/docs/api/disputes).
- `initiated`, `in_review`, `lost`, `funds_withdrawn`, `won`, and `cancelled` have been added as new values to enum query parameter `status.in` in [`list_disputes`](https://apidocs.chargebee.com/docs/api/disputes/list-disputes) of [`Dispute`](https://apidocs.chargebee.com/docs/api/disputes).
- `initiated`, `in_review`, `lost`, `funds_withdrawn`, `won`, and `cancelled` have been added as new values to enum query parameter `status.not_in` in [`list_disputes`](https://apidocs.chargebee.com/docs/api/disputes/list-disputes) of [`Dispute`](https://apidocs.chargebee.com/docs/api/disputes).
- `inquiry` and `chargeback` have been added as new values to enum query parameter `type.is` in [`list_disputes`](https://apidocs.chargebee.com/docs/api/disputes/list-disputes) of [`Dispute`](https://apidocs.chargebee.com/docs/api/disputes).
- `inquiry` and `chargeback` have been added as new values to enum query parameter `type.is_not` in [`list_disputes`](https://apidocs.chargebee.com/docs/api/disputes/list-disputes) of [`Dispute`](https://apidocs.chargebee.com/docs/api/disputes).
- `inquiry` and `chargeback` have been added as new values to enum query parameter `type.in` in [`list_disputes`](https://apidocs.chargebee.com/docs/api/disputes/list-disputes) of [`Dispute`](https://apidocs.chargebee.com/docs/api/disputes).
- `inquiry` and `chargeback` have been added as new values to enum query parameter `type.not_in` in [`list_disputes`](https://apidocs.chargebee.com/docs/api/disputes/list-disputes) of [`Dispute`](https://apidocs.chargebee.com/docs/api/disputes).
- `updated_at` has been added as a new value to enum query parameter `sort_by.asc` in [`list_e-invoices`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices) of [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- `updated_at` has been added as a new value to enum query parameter `sort_by.desc` in [`list_e-invoices`](https://apidocs.chargebee.com/docs/api/einvoices/list-e-invoices) of [`Einvoice`](https://apidocs.chargebee.com/docs/api/einvoices).
- `dankort` has been added as a new value to enum request body parameter `card.preferred_scheme` in [`create_an_invoice`](https://apidocs.chargebee.com/docs/api/invoices/create-an-invoice) of [`Invoice`](https://apidocs.chargebee.com/docs/api/invoices).
- `dankort` has been added as a new value to enum request body parameter `card.preferred_scheme` in [`create_invoice_for_items_and_one-time_charges`](https://apidocs.chargebee.com/docs/api/invoices/create-invoice-for-items-and-one-time-charges) of [`Invoice`](https://apidocs.chargebee.com/docs/api/invoices).
- `overdraft_settlement` has been added as a new value to enum query parameter `type.is` in [`list_ledger_operations`](https://apidocs.chargebee.com/docs/api/ledger_operations/list-ledger-operations) of [`LedgerOperation`](https://apidocs.chargebee.com/docs/api/ledger_operations).
- `overdraft_settlement` has been added as a new value to enum query parameter `type.in` in [`list_ledger_operations`](https://apidocs.chargebee.com/docs/api/ledger_operations/list-ledger-operations) of [`LedgerOperation`](https://apidocs.chargebee.com/docs/api/ledger_operations).
...
- `dankort` has been added as a new value to enum request body parameter `card.preferred_scheme` in [`create_a_card_payment_source`](https://apidocs.chargebee.com/docs/api/payment_sources/create-a-card-payment-source) of [`PaymentSource`](https://apidocs.chargebee.com/docs/api/payment_sources).
- `dankort` has been added as a new value to enum request body parameter `card.preferred_scheme` in [`update_subscription_for_items`](https://apidocs.chargebee.com/docs/api/subscriptions/update-subscription-for-items) of [`Subscription`](https://apidocs.chargebee.com/docs/api/subscriptions).
- `dankort` has been added as a new value to enum request body parameter `card.preferred_scheme` in [`create_a_subscription`](https://apidocs.chargebee.com/docs/api/subscriptions/create-a-subscription) of [`Subscription`](https://apidocs.chargebee.com/docs/api/subscriptions).
- `dankort` has been added as a new value to enum request body parameter `card.preferred_scheme` in [`update_a_subscription`](https://apidocs.chargebee.com/docs/api/subscriptions/update-a-subscription) of [`Subscription`](https://apidocs.chargebee.com/docs/api/subscriptions).
- `dankort` has been added as a new value to enum request body parameter `card.preferred_scheme` in [`import_a_subscription`](https://apidocs.chargebee.com/docs/api/subscriptions/import-a-subscription) of [`Subscription`](https://apidocs.chargebee.com/docs/api/subscriptions).


### Deprecated Attributes:
- [`granted_amount`](https://apidocs.chargebee.com/docs/api/grant_blocks/grant-block-object#granted_amount) has been deprecated in [`GrantBlock`](https://apidocs.chargebee.com/docs/api/grant_blocks).
- [`balance`](https://apidocs.chargebee.com/docs/api/grant_blocks/grant-block-object#balance) has been deprecated in [`GrantBlock`](https://apidocs.chargebee.com/docs/api/grant_blocks).
- [`hold_amount`](https://apidocs.chargebee.com/docs/api/grant_blocks/grant-block-object#hold_amount) has been deprecated in [`GrantBlock`](https://apidocs.chargebee.com/docs/api/grant_blocks).
- [`used_amount`](https://apidocs.chargebee.com/docs/api/grant_blocks/grant-block-object#used_amount) has been deprecated in [`GrantBlock`](https://apidocs.chargebee.com/docs/api/grant_blocks).
- [`expired_amount`](https://apidocs.chargebee.com/docs/api/grant_blocks/grant-block-object#expired_amount) has been deprecated in [`GrantBlock`](https://apidocs.chargebee.com/docs/api/grant_blocks).
- [`rolled_over_amount`](https://apidocs.chargebee.com/docs/api/grant_blocks/grant-block-object#rolled_over_amount) has been deprecated in [`GrantBlock`](https://apidocs.chargebee.com/docs/api/grant_blocks).
- [`voided_amount`](https://apidocs.chargebee.com/docs/api/grant_blocks/grant-block-object#voided_amount) has been deprecated in [`GrantBlock`](https://apidocs.chargebee.com/docs/api/grant_blocks).
...
#### Fixes:
* Support for Json format in JSONObject and JSONArray type request parameters 
...
* * *
#### Fixes:
* Migrated to the python-requests http lib.
* Added missing import for Usage.
* Added None check if params is None for list request.
* Replaced equals operator with is in compat.py file.
...
### v2.8.3 (2021-05-05)
* Added item modules for Product Catalog 2.0
